...
montrez que
  ...
  (b) $\rho_2=0.8\rho_1+0.6\sigma_{\varepsilon_t}^2/\gamma_0$

### Exercice 4

Considérez deux processus MA(2), un avec $\theta_1=\theta_2=1/6$ et un autre
avec $\theta_1=-1$ et $\theta_2=6$

  (a) Montrez que ces processus ont la même fonction d'autocorrelation
  (b) Comment les racines des polynômes caractéristiques correspondants 
  se comparent-elles ?
