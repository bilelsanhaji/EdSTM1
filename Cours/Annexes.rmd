...
\[
\begin{aligned}
\gamma_0 &= \text{Var}[Y_t] = \mathbb{E}[Y_t^2] \quad (4.136) \\
...
\[
\begin{aligned}
\gamma_1 &= \mathbb{E}[Y_t Y_{t-1}] \quad (4.137) \\
...
\[
\begin{aligned}
\gamma_2 &= \mathbb{E}[Y_t Y_{t-2}] \quad (4.138) \\
...
\[
\rho_1 = \frac{\gamma_1}{\gamma_0} = \frac{(\phi_1 + \theta_1)(1 + \phi_1 \theta_1)}{1 + \theta_1^2 + 2 \phi_1 \theta_1}. \quad (4.142)
\]
