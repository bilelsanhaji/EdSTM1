...
3.  Soit $\{\varepsilon_t\}$ un processus de bruit blanc à moyenne nulle. Supposons que le processus observé soit $Y_t = \varepsilon_t + \theta \varepsilon_{t-1}$, où $\theta$ est soit $3$, soit $\frac{1}{3}$.
